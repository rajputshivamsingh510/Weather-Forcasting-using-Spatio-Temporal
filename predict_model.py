...
model = load_model(r"C:\Users\21200\Desktop\akshat codes\8th sem project\weather_lstm_model.h5")
...
print("Predicted Temperature for the next day:", predicted_temp[0])
