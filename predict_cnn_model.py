...
model = load_model(r"C:\Users\21200\Desktop\akshat codes\8th sem project\weather_cnn_lstm_model.h5")
...
X_test = np.array(X_test).reshape((1, seq_length, len(features), 1))
...
print("Predicted Temperature for the next day (CNN-LSTM):", predicted_temp[0])
